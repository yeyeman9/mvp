...
class InterestsControllerTest < ActionController::TestCase
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post :create, interest: { imageURL: @interest.imageURL, name: @interest.name, string,: @interest.string,, string: @interest.string }
    end
  ...
  test "should update interest" do
    patch :update, id: @interest, interest: { imageURL: @interest.imageURL, name: @interest.name, string,: @interest.string,, string: @interest.string }
    assert_redirected_to interest_path(assigns(:interest))
  end
